...
buttons = [
    [
        InlineKeyboardButton(text="About Esther Robot", callback_data="esther_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Esther To Your Group ➗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Esther*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n Click on button bellow to get basic help for Esther.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Esther bot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Esther support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Esther.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
        ...
        query.message.edit_text(
            ...
            "\nHere Developers Making And Give Inspiration For Made The Esther",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
